...
plt.xscale('log')
plt.savefig("Ea_schéma1_xlog.png")
plt.yscale('log')
plt.savefig("Ea_schéma1_loglog.png")


xi = np.linspace(0, np.pi/8.,1000)
fig=plt.figure(3)
plt.title('Erreur d\'amplitude schéma 2')
plt.xlabel('xi')
plt.ylabel('E(xi)')
...
plt.xscale('log')
plt.savefig("Ea_schéma2_xlog.png")
plt.yscale('log')
plt.savefig("Ea_schéma2_loglog.png")

xi = np.linspace(0, np.pi/8.,1000)
fig=plt.figure(4)
plt.title('Erreur d\'amplitude schéma 3')
plt.xlabel('xi')
plt.ylabel('E(xi)')
...
plt.xscale('log')
plt.savefig("Ea_schéma3_xlog.png")
plt.yscale('log')
plt.xlabel('log(xi)')
plt.ylabel('log(E(xi))')
